package net.hoys.turtlemod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.hoys.turtlemod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.LEAD_ARMOR_MATERIAL,
                    ...
                    .put(ArmorMaterials.GOLD,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 1, 2, false, true),
                                    new StatusEffectInstance(StatusEffects.SPEED, 0, 1, true, true)))
                    .build();
